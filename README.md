...
业务空间 Base URL 和 API Key。页面可为已知百炼 Qwen 模型识别官方价格预设，并显示来源、
地区和阶梯限制；OpenAI-compatible 协议没有统一价格接口，未知模型仍需按服务商控制台手动填写。
...
在线编辑器和独立“提交评测”按钮，无需在题目详情与作答页之间跳转。个人历史位于顶部独立
“提交记录”页，记录以不同颜色区分 AC、WA、TLE、MLE、RE、CE、UNK 与 Pending，点击
